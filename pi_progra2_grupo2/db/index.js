    ...
    lista: [
        {
            ...
            comentarios: [
                {
                    usuario: "Juan",
                    texto: "Muy cómodo y calentito",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Ana",
                    texto: "Me encantó el diseño",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Pedro",
                    texto: "Lo uso todos los días",
                    imagen: "profile-default.png"
                }
            ]
        },
...

        {
            ...
            comentarios: [
                {
                    usuario: "Sofía",
                    texto: "Me queda perfecto",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Nico",
                    texto: "Muy cómodo para usar todos los días",
                    imagen: "profile-default.png"
                }
            ]
        },
...

        {
            ...
            comentarios: [
                {
                    usuario: "Caro",
                    texto: "Brilla muchísimo, me encanta",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Flor",
                    texto: "Ideal para salir",
                    imagen: "profile-default.png"
                }
            ]
        },
...

        {
            ...
            comentarios: [
                {
                    usuario: "Tomás",
                    texto: "La estampa es tremenda",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Juli",
                    texto: "Me gustó mucho el corte",
                    imagen: "profile-default.png"
                }
            ]
        },

        {
            ...
            comentarios: [
                {
                    usuario: "Leo",
                    texto: "Muy fresco para el verano",
                    imagen: "profile-default.png"
                }
            ]
        },
...

        {
            ...
            comentarios: [
                {
                    usuario: "Sofi",
                    texto: "Perfecto para una fiesta",
                    imagen: "profile-default.png"
                },
                {
                    usuario: "Luz",
                    texto: "Elegante y hermoso",
                    imagen: "profile-default.png"
                }
            ]
        }
